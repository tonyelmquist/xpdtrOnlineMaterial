    ...
    >
      ...
      <Container maxWidth="sm" component="main" className={classes.heroContent}>
        ...
        <Typography
          ...
          color="inherit"
        >
          Go ahead and play around with XPDTR using the sample data supplied! Make sure to
          take a look at the tutorial videos if you're wondering how to do something. When you're ready to get started,
          choose your plan from the following options:
        </Typography>
      </Container>
      {/* End hero unit */}
